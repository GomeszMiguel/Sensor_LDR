...
\begin{DoxyItemize}
\item Este programa lê valores do ADC exportados no sysfs e converte a resistência do LDR em uma estimativa percentual de luminosidade (0\% = escuro, 100\% = claro). O valor lido é então enviado via protocolo UDP (datagrama) para o servidor rodando no endereço SERVER\+\_\+\+IP (Host Windows/\+WSL) na porta 8080. 
\end{DoxyItemize}
\end{DoxyDate}
...
\begin{DoxyCode}{0}
\DoxyCodeLine{00115\ \ \ \ \ \ \ \ \ \ \ \ \{}
\DoxyCodeLine{00116\ \ \ \ \ \textcolor{comment}{//\ Inicializa\ o\ sensor\ LDR\ com\ o\ caminho\ do\ arquivo\ ADC\ no\ sysfs\ da\ placa}}
\DoxyCodeLine{00117\ \ \ \ \ \mbox{\hyperlink{class_sensor_l_d_r}{SensorLDR}}\ ldr(\textcolor{stringliteral}{"{}/sys/bus/iio/devices/iio:device0/in\_voltage13\_raw"{}});}
\DoxyCodeLine{00118\ }
\DoxyCodeLine{00119\ \ \ \ \ \textcolor{keywordtype}{int}\ client\_socket;}
\DoxyCodeLine{00120\ \ \ \ \ \textcolor{keyword}{struct\ }sockaddr\_in\ server\_addr;}
\DoxyCodeLine{00121\ \ \ \ \ \textcolor{keywordtype}{char}\ buffer[\mbox{\hyperlink{cliente_u_d_p__sensor__ldr_8cpp_a6b20d41d6252e9871430c242cb1a56e7}{BUFFER\_SIZE}}];}
\DoxyCodeLine{00122\ \ \ \ \ }
\DoxyCodeLine{00123\ \ \ \ \ \textcolor{comment}{//\ 1.\ Criar\ o\ Socket}}
\DoxyCodeLine{00124\ \ \ \ \ \textcolor{comment}{//\ AF\_INET:\ Endereços\ IPv4}}
\DoxyCodeLine{00125\ \ \ \ \ \textcolor{comment}{//\ SOCK\_DGRAM:\ Protocolo\ UDP\ (datagrama,\ sem\ conexão)}}
\DoxyCodeLine{00126\ \ \ \ \ client\_socket\ =\ socket(AF\_INET,\ SOCK\_DGRAM,\ 0);}
\DoxyCodeLine{00127\ \ \ \ \ \textcolor{keywordflow}{if}\ (client\_socket\ <\ 0)\ \{}
\DoxyCodeLine{00128\ \ \ \ \ \ \ \ \ perror(\textcolor{stringliteral}{"{}Erro\ ao\ criar\ o\ socket\ UDP\ do\ cliente"{}});}
\DoxyCodeLine{00129\ \ \ \ \ \ \ \ \ \textcolor{keywordflow}{return}\ -\/1;}
\DoxyCodeLine{00130\ \ \ \ \ \}}
\DoxyCodeLine{00131\ }
\DoxyCodeLine{00132\ \ \ \ \ \textcolor{comment}{//\ Limpar\ e\ configurar\ o\ endereço\ do\ servidor}}
\DoxyCodeLine{00133\ \ \ \ \ memset(\&server\_addr,\ 0,\ \textcolor{keyword}{sizeof}(server\_addr));}
\DoxyCodeLine{00134\ \ \ \ \ server\_addr.sin\_family\ =\ AF\_INET;}
\DoxyCodeLine{00135\ \ \ \ \ server\_addr.sin\_port\ =\ htons(\mbox{\hyperlink{cliente_u_d_p__sensor__ldr_8cpp_a614217d263be1fb1a5f76e2ff7be19a2}{PORT}});\ \textcolor{comment}{//\ Converte\ a\ porta\ (8080)\ para\ a\ ordem\ de\ bytes\ de\ rede}}
\DoxyCodeLine{00136\ }
\DoxyCodeLine{00137\ \ \ \ \ \textcolor{comment}{//\ Converter\ endereço\ IP\ de\ string\ para\ formato\ binário}}
\DoxyCodeLine{00138\ \ \ \ \ \textcolor{keywordflow}{if}\ (inet\_pton(AF\_INET,\ \mbox{\hyperlink{cliente_u_d_p__sensor__ldr_8cpp_a28d06fc286f28044ed3380969700ff3f}{SERVER\_IP}},\ \&server\_addr.sin\_addr)\ <=\ 0)\ \{}
\DoxyCodeLine{00139\ \ \ \ \ \ \ \ \ perror(\textcolor{stringliteral}{"{}Endereco\ IP\ invalido/nao\ suportado"{}});}
\DoxyCodeLine{00140\ \ \ \ \ \ \ \ \ close(client\_socket);}
\DoxyCodeLine{00141\ \ \ \ \ \ \ \ \ \textcolor{keywordflow}{return}\ -\/1;}
\DoxyCodeLine{00142\ \ \ \ \ \}}
\DoxyCodeLine{00143\ \ \ \ \ }
\DoxyCodeLine{00144\ \ \ \ \ cout\ <<\ \textcolor{stringliteral}{"{}Socket\ UDP\ criado\ com\ sucesso."{}}\ <<\ endl;}
\DoxyCodeLine{00145\ }
\DoxyCodeLine{00149\ \ \ \ \ \textcolor{keywordflow}{while}\ (\textcolor{keyword}{true})\ \{}
\DoxyCodeLine{00150\ \ \ \ \ \ \ \ \ memset(buffer,\ 0,\ \mbox{\hyperlink{cliente_u_d_p__sensor__ldr_8cpp_a6b20d41d6252e9871430c242cb1a56e7}{BUFFER\_SIZE}});}
\DoxyCodeLine{00151\ }
\DoxyCodeLine{00152\ \ \ \ \ \ \ \ \ \textcolor{comment}{//\ O\ valor\ lido\ do\ sensor\ é\ um\ INT}}
\DoxyCodeLine{00153\ \ \ \ \ \ \ \ \ \textcolor{keywordtype}{int}\ val\ =\ ldr.lerLuminosidadePercentual();}
\DoxyCodeLine{00154\ }
\DoxyCodeLine{00155\ \ \ \ \ \ \ \ \ \textcolor{comment}{//\ CORREÇÃO\ do\ erro:\ invalid\ conversion\ from\ 'int'\ to\ 'const\ char\ *'}}
\DoxyCodeLine{00156\ \ \ \ \ \ \ \ \ \textcolor{comment}{//\ 1.\ Converte\ o\ valor\ inteiro\ (int)\ para\ uma\ string\ C++\ (std::string)}}
\DoxyCodeLine{00157\ \ \ \ \ \ \ \ \ \textcolor{keywordtype}{string}\ val\_str\ =\ to\_string(val);}
\DoxyCodeLine{00158\ }
\DoxyCodeLine{00159\ \ \ \ \ \ \ \ \ \textcolor{comment}{//\ 2.\ Obtém\ o\ ponteiro\ C-\/style\ (const\ char*)\ da\ string\ para\ uso\ na\ função\ sendto()}}
\DoxyCodeLine{00160\ \ \ \ \ \ \ \ \ \textcolor{keyword}{const}\ \textcolor{keywordtype}{char}\ *message\ =\ val\_str.c\_str();\ }
\DoxyCodeLine{00161\ \ \ \ \ }
\DoxyCodeLine{00162\ \ \ \ \ \ \ \ \ \textcolor{comment}{//\ Calcula\ o\ tamanho\ da\ mensagem\ (apenas\ o\ tamanho\ da\ string,\ sem\ o\ terminador\ nulo)}}
\DoxyCodeLine{00163\ \ \ \ \ \ \ \ \ \textcolor{keywordtype}{size\_t}\ message\_len\ =\ val\_str.length();}
\DoxyCodeLine{00164\ }
\DoxyCodeLine{00174\ \ \ \ \ \ \ \ \ ssize\_t\ bytes\_sent\ =\ sendto(client\_socket,\ message,\ message\_len,\ 0,\ (\textcolor{keyword}{const}\ \textcolor{keyword}{struct}\ sockaddr\ *)\&server\_addr,\ \textcolor{keyword}{sizeof}(server\_addr));}
\DoxyCodeLine{00175\ }
\DoxyCodeLine{00176\ \ \ \ \ \ \ \ \ \textcolor{keywordflow}{if}\ (bytes\_sent\ ==\ -\/1)\ \{}
\DoxyCodeLine{00177\ \ \ \ \ \ \ \ \ \ \ \ \ perror(\textcolor{stringliteral}{"{}Erro\ ao\ enviar\ datagrama"{}});}
\DoxyCodeLine{00178\ \ \ \ \ \ \ \ \ \}\ }
\DoxyCodeLine{00179\ \ \ \ \ \ \ \ \ \textcolor{keywordflow}{else}\{}
\DoxyCodeLine{00180\ \ \ \ \ \ \ \ \ \ \ \ \ cout\ <<\ \textcolor{stringliteral}{"{}Datagrama\ enviado\ ("{}}\ <<\ bytes\_sent\ <<\ \textcolor{stringliteral}{"{}\ bytes)\ para\ "{}}\ <<\ \mbox{\hyperlink{cliente_u_d_p__sensor__ldr_8cpp_a28d06fc286f28044ed3380969700ff3f}{SERVER\_IP}}\ <<\ \textcolor{stringliteral}{"{}:"{}}\ <<\ \mbox{\hyperlink{cliente_u_d_p__sensor__ldr_8cpp_a614217d263be1fb1a5f76e2ff7be19a2}{PORT}}\ <<\ endl;}
\DoxyCodeLine{00181\ \ \ \ \ \ \ \ \ \ \ \ \ cout\ <<\ \textcolor{stringliteral}{"{}Luminosidade:\ "{}}\ <<\ message\ <<\ \textcolor{stringliteral}{"{}\%"{}}\ <<\ std::endl;}
\DoxyCodeLine{00182\ \ \ \ \ \ \ \ \ \ \ \ \ sleep(1);\ \textcolor{comment}{//\ Espera\ 1\ segundo\ antes\ da\ próxima\ leitura/envio}}
\DoxyCodeLine{00183\ \ \ \ \ \ \ \ \ \}}
\DoxyCodeLine{00184\ \ \ \ \ \}}
\DoxyCodeLine{00185\ \ \ \ \ \textcolor{comment}{//\ O\ loop\ é\ infinito,\ o\ código\ abaixo\ só\ seria\ executado\ em\ caso\ de\ interrupção}}
\DoxyCodeLine{00186\ \ \ \ \ \textcolor{comment}{//\ 4.\ Fechar\ o\ Socket}}
\DoxyCodeLine{00187\ \ \ \ \ close(client\_socket);}
\DoxyCodeLine{00188\ \ \ \ \ cout\ <<\ \textcolor{stringliteral}{"{}Socket\ fechado.\ Cliente\ UDP\ encerrado."{}}\ <<\ endl;}
